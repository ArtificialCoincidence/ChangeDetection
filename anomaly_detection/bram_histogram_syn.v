...
`endif
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[7:0],
		eq_wire = {w_anode1132w[3], w_anode1122w[3], w_anode1112w[3], w_anode1102w[3], w_anode1092w[3], w_anode1082w[3], w_anode1072w[3], w_anode1055w[3]},
		w_anode1055w = {(w_anode1055w[2] & (~ data_wire[2])), (w_anode1055w[1] & (~ data_wire[1])), (w_anode1055w[0] & (~ data_wire[0])), enable_wire},
		...
		w_anode1112w = {(w_anode1112w[2] & data_wire[2]), (w_anode1112w[1] & (~ data_wire[1])), (w_anode1112w[0] & data_wire[0]), enable_wire},
		w_anode1122w = {(w_anode1122w[2] & data_wire[2]), (w_anode1122w[1] & data_wire[1]), (w_anode1122w[0] & (~ data_wire[0])), enable_wire},
		w_anode1132w = {(w_anode1132w[2] & data_wire[2]), (w_anode1132w[1] & data_wire[1]), (w_anode1132w[0] & data_wire[0]), enable_wire};
endmodule //bram_histogram_decode
...
module  bram_histogram_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	bram_histogram_decode   decode2
	( 
	.data(address_a_wire[15:13]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	bram_histogram_mux   mux3
	( 
...
, wire_ram_block1a_14portbdataout[0], wire_ram_block1a_13portbdataout[0], wire_ram_block1a_12portbdataout[0], wire_ram_block1a_11portbdataout[0], wire_ram_block1a_10portbdataout[0], wire_ram_block1a_9portbdataout[0], wire_ram_block1a_8portbdataout[0], wire_ram_block1a_7portbdataout[0], wire_ram_block1a_6portbdataout[0], wire_ram_block1a_5portbdataout[0], wire_ram_block1a_4portbdataout[0], wire_ram_block1a_3portbdataout[0], wire_ram_block1a_2portbdataout[0], wire_ram_block1a_1portbdataout[0], wire_ram_block1a_0portbdataout[0]}),
	...
	defparam
		...
		ram_block1a_64.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_65.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_66.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_67.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_68.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_69.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_70.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_71.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_72.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_73.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_74.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_75.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_76.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_77.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_78.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_79.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_80.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_81.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_82.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_83.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_84.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_85.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_86.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_87.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_88.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_89.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_90.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_91.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_92.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_93.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_94.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_95.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_96.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_97.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_98.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_99.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_100.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_101.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_102.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_103.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_104.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_105.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_106.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_107.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_108.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_109.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_110.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_111.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_112.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_113.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_114.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_115.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_116.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_117.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_118.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_119.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_120.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_121.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_122.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_123.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_124.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_125.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_126.mixed_port_feed_through_mode = "old",
	...
	defparam
		...
		ram_block1a_127.mixed_port_feed_through_mode = "old",
...
endmodule //bram_histogram_altsyncram
//VALID FILE
...
`endif
	...
	bram_histogram_altsyncram	bram_histogram_altsyncram_component (
				.address_a (wraddress),
				.address_b (rdaddress),
				.clock0 (clock),
				.data_a (data),
