...
main = do
    ...
    let writepath = "./Out/" ++ mission ++ "/Lag2/ImageSplitting" 
    ...
    pid1 <- forkIO $ do
        ...
        let subImage1 = atMat 0 0 n_test;st1 = signal [subImage1]
            ...
            u_1 = vector [test_1,ref1_1,test_1,ref2_1]
    ...
    pid2 <- forkIO $ do
        ...
        let subImage2 = atMat 0 1 n_test;st2 = signal [subImage2]
            ...
            u_2 = vector [test_2,ref1_2,test_2,ref2_2]
    ...
    pid3 <- forkIO $ do
        ...
        let subImage3 = atMat 1 0 n_test;st3 = signal [subImage3]
            ...
            u_3 = vector [test_3,ref1_3,test_3,ref2_3]
    ...
    pid4 <- forkIO $ do
        ...
        let subImage4 = atMat 1 1 n_test;st4 = signal [subImage4]
            ...
            u_4 = vector [test_4,ref1_4,test_4,ref2_4]
