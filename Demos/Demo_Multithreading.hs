...
main = do
    ...
    ref2 <- openFile "SampleData/test6/Iref6B.dat" ReadMode; contentsRef2 <- hGetContents ref2
    ref3 <- openFile "SampleData/test6/Iref6C.dat" ReadMode; contentsRef3 <- hGetContents ref3
    ref4 <- openFile "SampleData/test6/Iref6D.dat" ReadMode; contentsRef4 <- hGetContents ref4
    ...
    ----- Output File ------------------------------------------------------------------------------------------------
    writeFile "Out/CD0.txt" (show res)
