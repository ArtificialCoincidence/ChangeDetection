...
main = do
    ...
    pid1 <- forkIO $ do
        ...
        let result = zipWithxSY (procMatrix9 dimx dimy) u_1
    ...
    pid2 <- forkIO $ do
        ...
        let result = zipWithxSY (procMatrix9 dimx dimy) u_2
    ...
    pid3 <- forkIO $ do
        ...
        let result = zipWithxSY (procMatrix9 dimx dimy) u_3
    ...
    pid4 <- forkIO $ do
        ...
        let result = zipWithxSY (procMatrix9 dimx dimy) u_4
