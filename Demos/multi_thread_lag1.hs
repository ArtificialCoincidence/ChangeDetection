...
main = do
    ...
    let target = "18"
    -- let readpath = "SampleData/test0"; writepath = "Out/S1/Lag1/CD0.txt" -- S1
    -- let readpath = "SampleData/test6"; writepath = "Out/K1/Lag1/CD0.txt" -- K1
    -- let readpath = "SampleData/test12"; writepath = "Out/F1/Lag1/CD0.txt" -- F1
    let readpath = "SampleData/test18"; writepath = "Out/AF1/Lag1/CD0.txt" -- AF1
