...
procMatrix dimx dimy dat = fromMatrix res !! 0 
        ...
        cms = [sr1, sr2, sr3, sr4, sr5, sr6, sr7, sr8, sr9]
...
main = do
    ...
    let target = "12"
    -- let readpath = "SampleData/test0"; writepath = "Out/S1/Lag9/CD0.txt" -- S1
    -- let readpath = "SampleData/test6"; writepath = "Out/K1/Lag9/CD0.txt" -- K1
    let readpath = "SampleData/test12"; writepath = "Out/F1/Lag9/CD0.txt" -- F1
    -- let readpath = "SampleData/test18"; writepath = "Out/AF1/Lag9/CD0.txt" -- AF1
    ...
    -- ./multi_thread_lag9 +RTS -N8 -ls; threadscope multi_thread_lag9.eventlog
