...
procMatrix3 dimx dimy dat = cms !! head sorList
        ...
        sv = signal [ssr1, ssr2, ssr3]  -- partitioning here (Par Monad)
...
procMatrix6 dimx dimy dat = cms !! head sorList
        ...
        -- these ssrx shoulb be partitioned to a parallel scheduling 
        -- for example
        -- sv1 = signal [ssr1, ssr2, ssr3, ssr4, ssr5, ssr6] first positions of ssr1, ssr2, ssr3 .... core 1
        -- sv2 = signal [ssr1, ssr2, ssr3, ssr4, ssr5, ssr6] second positions of ssr1, ssr2, ssr3 .... core 2
        -- ...
        -- svn = signal [ssr1, ssr2, ssr3, ssr4, ssr5, ssr6] nth positions of ssr1, ssr2, ssr3 .... core n
...
procMatrix9 dimx dimy dat = cms !! head sorList
        ...
        sv = signal [ssr1, ssr2, ssr3, ssr4, ssr5, ssr6, ssr7, ssr8, ssr9] -- par Monad
...
main = do
    ...
    test <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Itest0.dat" ReadMode; contentsTest <- hGetContents test

    ref1 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0A.dat" ReadMode; contentsRef1 <- hGetContents ref1
    ref2 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0B.dat" ReadMode; contentsRef2 <- hGetContents ref2
    ref3 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0C.dat" ReadMode; contentsRef3 <- hGetContents ref3
    ref4 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0D.dat" ReadMode; contentsRef4 <- hGetContents ref4
    ref5 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0E.dat" ReadMode; contentsRef5 <- hGetContents ref5
    ref6 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0F.dat" ReadMode; contentsRef6 <- hGetContents ref6
    ref7 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0G.dat" ReadMode; contentsRef7 <- hGetContents ref7
    ref8 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0H.dat" ReadMode; contentsRef8 <- hGetContents ref8
    ref9 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0I.dat" ReadMode; contentsRef9 <- hGetContents ref9
    ref10 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0J.dat" ReadMode; contentsRef10 <- hGetContents ref10
    ref11 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0K.dat" ReadMode; contentsRef11 <- hGetContents ref11
    ref12 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0L.dat" ReadMode; contentsRef12 <- hGetContents ref12
    ref13 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0M.dat" ReadMode; contentsRef13 <- hGetContents ref13
    ref14 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0N.dat" ReadMode; contentsRef14 <- hGetContents ref14
    ref15 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0O.dat" ReadMode; contentsRef15 <- hGetContents ref15
    ref16 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0P.dat" ReadMode; contentsRef16 <- hGetContents ref16
    ref17 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0Q.dat" ReadMode; contentsRef17 <- hGetContents ref17
    ref18 <- openFile "/home/marcello-costa/workspace/Demos/SampleData/Iref0R.dat" ReadMode; contentsRef18 <- hGetContents ref18
    ...
    ----- Output File ------------------------------------------------------------------------------------------------
    --writeFile "/home/marcello-costa/workspace/Demos/Out/CD0.txt" (show m)
