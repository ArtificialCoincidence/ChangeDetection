...
procMatrix dimx dimy dat = res
        ...
        indices = signal[1, 3, 5, 7, 9, 11, 13, 15]
        ...
        pLists = [p1List] ++ [p2List] ++ [p3List] ++ [p4List] ++ [p5List] ++ [p6List] ++ [p7List] ++ [p8List]          
...
main = do
    ...
    let writepath = "./Out/" ++ mission ++ "/Lag8/ImageSplitting" 
        ...
        readpathL = readpath ++ "/Iref" ++ target ++"L.dat"
...
-- TODO change the images
    ...
    ref7 <- openFile readpathL ReadMode; contentsRef7 <- hGetContents ref7
    ref9 <- openFile readpathM ReadMode; contentsRef9 <- hGetContents ref9
    ref11 <- openFile readpathR ReadMode; contentsRef11 <- hGetContents ref11
    
-- TODO change the images
    ref13 <- openFile readpathM ReadMode; contentsRef13 <- hGetContents ref13
    ref15 <- openFile readpathR ReadMode; contentsRef15 <- hGetContents ref15
    ...
    pid1 <- forkIO $ do
        ...
        let subImage1 = atMat 0 0 n_test;st1 = signal [subImage1]
            ...
            u_1 = vector [test_1,ref1_1,test_1,ref2_1,test_1,ref3_1,test_1,ref4_1,test_1,ref5_1,test_1,ref6_1,test_1,ref7_1,test_1,ref8_1]
    ...
    pid2 <- forkIO $ do
        ...
        let subImage2 = atMat 0 1 n_test;st2 = signal [subImage2]
            ...
            u_2 = vector [test_2,ref1_2,test_2,ref2_2,test_2,ref3_2,test_2,ref4_2,test_2,ref5_2,test_2,ref6_2,test_2,ref7_2,test_2,ref8_2]
    ...
    pid3 <- forkIO $ do
        ...
        let subImage3 = atMat 1 0 n_test;st3 = signal [subImage3]
            ...
            u_3 = vector [test_3,ref1_3,test_3,ref2_3,test_3,ref3_3,test_3,ref4_3,test_3,ref5_3,test_3,ref6_3,test_3,ref7_3,test_3,ref8_3]
    ...
    pid4 <- forkIO $ do
        ...
        let subImage4 = atMat 1 1 n_test;st4 = signal [subImage4]
            ...
            u_4 = vector [test_4,ref1_4,test_4,ref2_4,test_4,ref3_4,test_4,ref4_4,test_4,ref5_4,test_4,ref6_4,test_4,ref7_4,test_4,ref8_4]
