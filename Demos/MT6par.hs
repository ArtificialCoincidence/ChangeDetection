...
main = do
    ...
    let readpath = "/home/marcello-costa/workspace/ChangeDetection/Data/test" ++ target; 
    let writepath = "/home/marcello-costa/workspace/ChangeDetection/Out/" ++ mission ++ "/Lag6/Par" 
