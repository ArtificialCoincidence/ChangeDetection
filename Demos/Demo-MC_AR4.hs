...
procMatrix dimx dimy dat = cms !! head sorList
        ...
        sv = signal [ssr1, ssr2, ssr3, ssr4] -- 4-lags test
        ...
        cms = [cm1, cm2, cm3, cm4] -- 4-lags test
...
main = do
    ...
    test <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Itest6.dat" ReadMode; contentsTest <- hGetContents test

    ref1 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6A.dat" ReadMode; contentsRef1 <- hGetContents ref1
    ref2 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6B.dat" ReadMode; contentsRef2 <- hGetContents ref2
    ref3 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6C.dat" ReadMode; contentsRef3 <- hGetContents ref3
    ref4 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6D.dat" ReadMode; contentsRef4 <- hGetContents ref4
    ref5 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6E.dat" ReadMode; contentsRef5 <- hGetContents ref5
    ref6 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6F.dat" ReadMode; contentsRef6 <- hGetContents ref6
    ref7 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6G.dat" ReadMode; contentsRef7 <- hGetContents ref7
    ref8 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6H.dat" ReadMode; contentsRef8 <- hGetContents ref8
    ref9 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6I.dat" ReadMode; contentsRef9 <- hGetContents ref9
    ref10 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6//Iref6J.dat" ReadMode; contentsRef10 <- hGetContents ref10
    ref11 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6K.dat" ReadMode; contentsRef11 <- hGetContents ref11
    ref12 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6L.dat" ReadMode; contentsRef12 <- hGetContents ref12
    ref13 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6M.dat" ReadMode; contentsRef13 <- hGetContents ref13
    ref14 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6N.dat" ReadMode; contentsRef14 <- hGetContents ref14
    ref15 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6O.dat" ReadMode; contentsRef15 <- hGetContents ref15
    ref16 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6P.dat" ReadMode; contentsRef16 <- hGetContents ref16
    ref17 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6Q.dat" ReadMode; contentsRef17 <- hGetContents ref17
    ref18 <- openFile "/home/marcello-costa/workspace/Demos/Data/test6/Iref6R.dat" ReadMode; contentsRef18 <- hGetContents ref18
    ...
    let dimx =500; dimy = 500
        ...
        u4 = vector [intest,inref1,intest, inref3, intest, inref5, intest, inref7]
    ...
    let m = zipWithxSY (procMatrix dimx dimy) u4 -- procMatrix using 4-lags
        v = lengthS m
        m1 = fromSignal m !! 0; cm1 = m1 `atV` 0
        w = sizeMat m1
