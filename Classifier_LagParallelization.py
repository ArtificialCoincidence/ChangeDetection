...
def Classifier(ICD,tp,pfa, TestType, pair):
            ...
            f.savefig(path + 'Class_LagParallelization_Multithreading_%s_%s.png'%(TestType, pair), dpi=350,bbox_inches='tight',transparent=True, pad_inches=0)
            f.tight_layout()
...
if __name__ == "__main__":
    ...
    if test[idtest] == 'AF1':
      path = './LagParallelization_Multithreading/Out/%s/Lag%s/LagParallelization/'%(test[idtest],Lag[idlag])
