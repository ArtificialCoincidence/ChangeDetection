...
main = do
    ...
    tid1 <- forkIO $ do
        ...
        writeFile "IPC6/proc1.txt" (show m)
        putMVar m1 m
    ...
    tid2 <- forkIO $ do
        ...
        writeFile "IPC6/proc2.txt" (show m)
        putMVar m2 m
    ...
    tid3 <- forkIO $ do
        ...
        writeFile "IPC6/proc3.txt" (show m)
        putMVar m3 m
    ...
    tid4 <- forkIO $ do
        ...
        writeFile "IPC6/proc4.txt" (show m)
        putMVar m4 m
    ...
    tid5 <- forkIO $ do
        ...
        writeFile "IPC6/proc5.txt" (show m)
        putMVar m5 m
    ...
    tid6 <- forkIO $ do
        ...
        writeFile "IPC6/proc6.txt" (show m)
        putMVar m6 m
    ...
    --  ghc -O2 LagParallelization_Multithreading_lag6.hs -threaded -rtsopts -eventlog
    -- ./LagParallelization_Multithreading_lag6 +RTS -N6 -ls; threadscope LagParallelization_Multithreading_lag6.eventlog