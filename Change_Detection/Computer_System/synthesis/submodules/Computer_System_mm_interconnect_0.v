...
module Computer_System_mm_interconnect_0 (
		...
		input  wire        Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset,  //  Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset.reset
		input  wire        VGA_Subsystem_sys_reset_reset_bridge_in_reset_reset,                   //                   VGA_Subsystem_sys_reset_reset_bridge_in_reset.reset
		input  wire [31:0] Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_address,          //            Change_Detection_Mem_to_Stream_DMA_avalon_dma_master.address
		output wire        Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_waitrequest,      //                                                                .waitrequest
		input  wire        Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_read,             //                                                                .read
		output wire [15:0] Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_readdata,         //                                                                .readdata
		output wire        Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_readdatavalid,    //                                                                .readdatavalid
		input  wire        Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_lock,             //                                                                .lock
		input  wire [31:0] Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_address,          //            Change_Detection_Stream_to_Mem_DMA_avalon_dma_master.address
		output wire        Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_waitrequest,      //                                                                .waitrequest
		input  wire        Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_write,            //                                                                .write
		input  wire [15:0] Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_writedata,        //                                                                .writedata
		...
		output wire [31:0] VGA_Subsystem_pixel_dma_master_readdata,                               //                                                                .readdata
	...
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest;   // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_waitrequest -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_waitrequest
	wire   [15:0] change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata;      // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_readdata -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_readdata
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess;   // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_debugaccess -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_debugaccess
	wire   [31:0] change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_address;       // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_address -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_address
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_read;          // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_read -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_read
	wire    [1:0] change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable;    // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_byteenable -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_byteenable
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid; // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_readdatavalid -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_readdatavalid
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_lock;          // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_lock -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_lock
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_write;         // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_write -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_write
	wire   [15:0] change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata;     // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_writedata -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_writedata
	wire    [1:0] change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount;    // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_translator:uav_burstcount -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:av_burstcount
	wire          rsp_mux_002_src_valid;                                                                                   // rsp_mux_002:src_valid -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_valid
	wire  [108:0] rsp_mux_002_src_data;                                                                                    // rsp_mux_002:src_data -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                                                   // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [4:0] rsp_mux_002_src_channel;                                                                                 // rsp_mux_002:src_channel -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                                                           // rsp_mux_002:src_startofpacket -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                                             // rsp_mux_002:src_endofpacket -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:rp_endofpacket
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest;   // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_waitrequest -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_waitrequest
	wire   [15:0] change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata;      // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_readdata -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_readdata
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess;   // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_debugaccess -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_debugaccess
	wire   [31:0] change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_address;       // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_address -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_address
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_read;          // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_read -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_read
	wire    [1:0] change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable;    // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_byteenable -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_byteenable
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid; // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_readdatavalid -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_readdatavalid
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_lock;          // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_lock -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_lock
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_write;         // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_write -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_write
	wire   [15:0] change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata;     // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_writedata -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_writedata
	wire    [1:0] change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount;    // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_translator:uav_burstcount -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:av_burstcount
	wire          rsp_mux_003_src_valid;                                                                                   // rsp_mux_003:src_valid -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_valid
	wire  [108:0] rsp_mux_003_src_data;                                                                                    // rsp_mux_003:src_data -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                                                   // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [4:0] rsp_mux_003_src_channel;                                                                                 // rsp_mux_003:src_channel -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_channel
	wire          rsp_mux_003_src_startofpacket;                                                                           // rsp_mux_003:src_startofpacket -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                                                             // rsp_mux_003:src_endofpacket -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:rp_endofpacket
	...
	wire   [31:0] vga_subsystem_pixel_dma_master_translator_avalon_universal_master_0_readdata;                            // VGA_Subsystem_pixel_dma_master_agent:av_readdata -> VGA_Subsystem_pixel_dma_master_translator:uav_readdata
	...
	wire    [3:0] vga_subsystem_pixel_dma_master_translator_avalon_universal_master_0_byteenable;                          // VGA_Subsystem_pixel_dma_master_translator:uav_byteenable -> VGA_Subsystem_pixel_dma_master_agent:av_byteenable
	...
	wire   [31:0] vga_subsystem_pixel_dma_master_translator_avalon_universal_master_0_writedata;                           // VGA_Subsystem_pixel_dma_master_translator:uav_writedata -> VGA_Subsystem_pixel_dma_master_agent:av_writedata
	wire    [2:0] vga_subsystem_pixel_dma_master_translator_avalon_universal_master_0_burstcount;                          // VGA_Subsystem_pixel_dma_master_translator:uav_burstcount -> VGA_Subsystem_pixel_dma_master_agent:av_burstcount
	...
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_valid;                                     // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:cp_valid -> router_002:sink_valid
	wire  [108:0] change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_data;                                      // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:cp_data -> router_002:sink_data
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_ready;                                     // router_002:sink_ready -> Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:cp_ready
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_startofpacket;                             // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_endofpacket;                               // Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_valid;                                     // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:cp_valid -> router_003:sink_valid
	wire  [108:0] change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_data;                                      // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:cp_data -> router_003:sink_data
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_ready;                                     // router_003:sink_ready -> Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:cp_ready
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_startofpacket;                             // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:cp_startofpacket -> router_003:sink_startofpacket
	wire          change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_endofpacket;                               // Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_agent:cp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [126:0] vga_subsystem_pixel_dma_master_agent_cp_data;                                                            // VGA_Subsystem_pixel_dma_master_agent:cp_data -> router_004:sink_data
	...
	wire  [108:0] sdram_s1_agent_rp_data;                                                                                  // SDRAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [108:0] router_005_src_data;                                                                                     // router_005:src_data -> rsp_demux:sink_data
	...
	wire  [108:0] cmd_demux_004_src0_data;                                                                                 // cmd_demux_004:src0_data -> cmd_mux:sink4_data
	...
	wire  [108:0] rsp_demux_src4_data;                                                                                     // rsp_demux:src4_data -> rsp_mux_004:sink0_data
	...
	wire    [4:0] rsp_mux_src_channel;                                                                                     // rsp_mux:src_channel -> ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_channel
	...
	wire  [162:0] arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_data;                                                 // ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_data -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_data
	...
	wire    [4:0] arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel;                                              // ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_channel -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                                                 // rsp_mux_001:src_channel -> ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_channel
	...
	wire  [162:0] arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_data;                                                 // ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_data -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_data
	...
	wire    [4:0] arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel;                                              // ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_channel -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_channel
	...
	wire          rsp_mux_004_src_valid;                                                                                   // rsp_mux_004:src_valid -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_valid
	wire  [108:0] rsp_mux_004_src_data;                                                                                    // rsp_mux_004:src_data -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_data
	wire          rsp_mux_004_src_ready;                                                                                   // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_ready -> rsp_mux_004:src_ready
	wire    [4:0] rsp_mux_004_src_channel;                                                                                 // rsp_mux_004:src_channel -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_channel
	wire          rsp_mux_004_src_startofpacket;                                                                           // rsp_mux_004:src_startofpacket -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_004_src_endofpacket;                                                                             // rsp_mux_004:src_endofpacket -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_endofpacket
	wire          vga_subsystem_pixel_dma_master_rsp_width_adapter_src_valid;                                              // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_valid -> VGA_Subsystem_pixel_dma_master_agent:rp_valid
	wire  [126:0] vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data;                                               // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_data -> VGA_Subsystem_pixel_dma_master_agent:rp_data
	wire          vga_subsystem_pixel_dma_master_rsp_width_adapter_src_ready;                                              // VGA_Subsystem_pixel_dma_master_agent:rp_ready -> VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_ready
	wire    [4:0] vga_subsystem_pixel_dma_master_rsp_width_adapter_src_channel;                                            // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_channel -> VGA_Subsystem_pixel_dma_master_agent:rp_channel
	wire          vga_subsystem_pixel_dma_master_rsp_width_adapter_src_startofpacket;                                      // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_startofpacket -> VGA_Subsystem_pixel_dma_master_agent:rp_startofpacket
	wire          vga_subsystem_pixel_dma_master_rsp_width_adapter_src_endofpacket;                                        // VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_endofpacket -> VGA_Subsystem_pixel_dma_master_agent:rp_endofpacket
	wire          router_src_valid;                                                                                        // router:src_valid -> ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_valid
	wire  [162:0] router_src_data;                                                                                         // router:src_data -> ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_data
	wire          router_src_ready;                                                                                        // ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_ready -> router:src_ready
	wire    [4:0] router_src_channel;                                                                                      // router:src_channel -> ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_channel
	...
	wire    [4:0] arm_a9_hps_h2f_axi_master_wr_cmd_width_adapter_src_channel;                                              // ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	...
	wire  [162:0] router_001_src_data;                                                                                     // router_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:in_data
	wire          router_001_src_ready;                                                                                    // ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:in_ready -> router_001:src_ready
	wire    [4:0] router_001_src_channel;                                                                                  // router_001:src_channel -> ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:in_channel
	...
	wire    [4:0] arm_a9_hps_h2f_axi_master_rd_cmd_width_adapter_src_channel;                                              // ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	...
	wire          router_004_src_valid;                                                                                    // router_004:src_valid -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_valid
	wire  [126:0] router_004_src_data;                                                                                     // router_004:src_data -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_data
	wire          router_004_src_ready;                                                                                    // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_ready -> router_004:src_ready
	wire    [4:0] router_004_src_channel;                                                                                  // router_004:src_channel -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                                                            // router_004:src_startofpacket -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                                                              // router_004:src_endofpacket -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:in_endofpacket
	wire          vga_subsystem_pixel_dma_master_cmd_width_adapter_src_valid;                                              // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_valid -> cmd_demux_004:sink_valid
	wire  [108:0] vga_subsystem_pixel_dma_master_cmd_width_adapter_src_data;                                               // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_data -> cmd_demux_004:sink_data
	wire          vga_subsystem_pixel_dma_master_cmd_width_adapter_src_ready;                                              // cmd_demux_004:sink_ready -> VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_ready
	wire    [4:0] vga_subsystem_pixel_dma_master_cmd_width_adapter_src_channel;                                            // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_channel -> cmd_demux_004:sink_channel
	wire          vga_subsystem_pixel_dma_master_cmd_width_adapter_src_startofpacket;                                      // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_startofpacket -> cmd_demux_004:sink_startofpacket
	wire          vga_subsystem_pixel_dma_master_cmd_width_adapter_src_endofpacket;                                        // VGA_Subsystem_pixel_dma_master_cmd_width_adapter:out_endofpacket -> cmd_demux_004:sink_endofpacket
	...
	) change_detection_mem_to_stream_dma_avalon_dma_master_translator (
		.clk                    (System_PLL_sys_clk_clk),                                                                                  //                       clk.clk
		.reset                  (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),                                    //                     reset.reset
		.uav_address            (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_waitrequest),                                        //                          .waitrequest
		.av_read                (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_read),                                               //                          .read
		.av_readdata            (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_readdatavalid),                                      //                          .readdatavalid
		.av_lock                (Change_Detection_Mem_to_Stream_DMA_avalon_dma_master_lock),                                               //                          .lock
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) change_detection_stream_to_mem_dma_avalon_dma_master_translator (
		.clk                    (System_PLL_sys_clk_clk),                                                                                  //                       clk.clk
		.reset                  (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),                                    //                     reset.reset
		.uav_address            (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_waitrequest),                                        //                          .waitrequest
		.av_write               (Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_write),                                              //                          .write
		.av_writedata           (Change_Detection_Stream_to_Mem_DMA_avalon_dma_master_writedata),                                          //                          .writedata
		.av_burstcount          (1'b1),                                                                                                    //               (terminated)
		.av_byteenable          (2'b11),                                                                                                   //               (terminated)
		.av_beginbursttransfer  (1'b0),                                                                                                    //               (terminated)
		.av_begintransfer       (1'b0),                                                                                                    //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) change_detection_mem_to_stream_dma_avalon_dma_master_agent (
		.clk                   (System_PLL_sys_clk_clk),                                                                                  //       clk.clk
		.reset                 (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),                                    // clk_reset.reset
		.av_address            (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (change_detection_mem_to_stream_dma_avalon_dma_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) change_detection_stream_to_mem_dma_avalon_dma_master_agent (
		.clk                   (System_PLL_sys_clk_clk),                                                                                  //       clk.clk
		.reset                 (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),                                    // clk_reset.reset
		.av_address            (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (change_detection_stream_to_mem_dma_avalon_dma_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                                  // (terminated)
		.av_writeresponsevalid ()                                                                                   // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_valid),         //          .valid
		.sink_data          (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_data),          //          .data
		.sink_startofpacket (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (change_detection_mem_to_stream_dma_avalon_dma_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                                      //       clk.clk
		.reset              (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	Computer_System_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_valid),         //          .valid
		.sink_data          (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_data),          //          .data
		.sink_startofpacket (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (change_detection_stream_to_mem_dma_avalon_dma_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                                      //       clk.clk
		.reset              (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
	...
	Computer_System_mm_interconnect_0_cmd_demux cmd_demux_004 (
		.clk                (System_PLL_sys_clk_clk),                                               //       clk.clk
		.reset              (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.sink_ready         (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_ready),           //      sink.ready
		.sink_channel       (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_channel),         //          .channel
		.sink_data          (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_data),            //          .data
		.sink_startofpacket (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_startofpacket),   //          .startofpacket
		.sink_endofpacket   (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_endofpacket),     //          .endofpacket
		.sink_valid         (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_valid),           //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) vga_subsystem_pixel_dma_master_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                               //       clk.clk
		.reset                (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_endofpacket),     //       src.endofpacket
		.out_data             (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data),            //          .data
		.out_channel          (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_channel),         //          .channel
		.out_valid            (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_valid),           //          .valid
		.out_ready            (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_ready),           //          .ready
		.out_startofpacket    (vga_subsystem_pixel_dma_master_rsp_width_adapter_src_startofpacket),   //          .startofpacket
		.in_command_size_data (3'b000)                                                                // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) vga_subsystem_pixel_dma_master_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                               //       clk.clk
		.reset                (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_endofpacket),     //       src.endofpacket
		.out_data             (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_data),            //          .data
		.out_channel          (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_channel),         //          .channel
		.out_valid            (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_valid),           //          .valid
		.out_ready            (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_ready),           //          .ready
		.out_startofpacket    (vga_subsystem_pixel_dma_master_cmd_width_adapter_src_startofpacket),   //          .startofpacket
		.in_command_size_data (3'b000)                                                                // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (Change_Detection_Mem_to_Stream_DMA_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
