...
module Computer_System_mm_interconnect_1 (
		...
		output wire [1:0]  Change_Detection_Mem_to_Stream_Translator_slave_address,                  //                    Change_Detection_Mem_to_Stream_Translator_slave.address
		output wire        Change_Detection_Mem_to_Stream_Translator_slave_write,                    //                                                                   .write
		output wire        Change_Detection_Mem_to_Stream_Translator_slave_read,                     //                                                                   .read
		input  wire [31:0] Change_Detection_Mem_to_Stream_Translator_slave_readdata,                 //                                                                   .readdata
		output wire [31:0] Change_Detection_Mem_to_Stream_Translator_slave_writedata,                //                                                                   .writedata
		output wire [3:0]  Change_Detection_Mem_to_Stream_Translator_slave_byteenable,               //                                                                   .byteenable
		input  wire        Change_Detection_Mem_to_Stream_Translator_slave_waitrequest,              //                                                                   .waitrequest
		output wire [1:0]  Change_Detection_Stream_to_Mem_Translator_slave_address,                  //                    Change_Detection_Stream_to_Mem_Translator_slave.address
		output wire        Change_Detection_Stream_to_Mem_Translator_slave_write,                    //                                                                   .write
		output wire        Change_Detection_Stream_to_Mem_Translator_slave_read,                     //                                                                   .read
		input  wire [31:0] Change_Detection_Stream_to_Mem_Translator_slave_readdata,                 //                                                                   .readdata
		output wire [31:0] Change_Detection_Stream_to_Mem_Translator_slave_writedata,                //                                                                   .writedata
		output wire [3:0]  Change_Detection_Stream_to_Mem_Translator_slave_byteenable,               //                                                                   .byteenable
		input  wire        Change_Detection_Stream_to_Mem_Translator_slave_waitrequest,              //                                                                   .waitrequest
	...
	wire   [31:0] change_detection_mem_to_stream_translator_slave_agent_m0_readdata;                   // Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_readdata -> Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_readdata
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_waitrequest;                // Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_waitrequest -> Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_waitrequest
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_debugaccess;                // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_debugaccess -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_debugaccess
	wire   [20:0] change_detection_mem_to_stream_translator_slave_agent_m0_address;                    // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_address -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_address
	wire    [3:0] change_detection_mem_to_stream_translator_slave_agent_m0_byteenable;                 // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_byteenable -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_byteenable
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_read;                       // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_read -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_read
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_readdatavalid;              // Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_readdatavalid -> Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_readdatavalid
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_lock;                       // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_lock -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_lock
	wire   [31:0] change_detection_mem_to_stream_translator_slave_agent_m0_writedata;                  // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_writedata -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_writedata
	wire          change_detection_mem_to_stream_translator_slave_agent_m0_write;                      // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_write -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_write
	wire    [2:0] change_detection_mem_to_stream_translator_slave_agent_m0_burstcount;                 // Change_Detection_Mem_to_Stream_Translator_slave_agent:m0_burstcount -> Change_Detection_Mem_to_Stream_Translator_slave_translator:uav_burstcount
	wire          change_detection_mem_to_stream_translator_slave_agent_rf_source_valid;               // Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_source_valid -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:in_valid
	wire  [114:0] change_detection_mem_to_stream_translator_slave_agent_rf_source_data;                // Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_source_data -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:in_data
	wire          change_detection_mem_to_stream_translator_slave_agent_rf_source_ready;               // Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:in_ready -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_source_ready
	wire          change_detection_mem_to_stream_translator_slave_agent_rf_source_startofpacket;       // Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_source_startofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:in_startofpacket
	wire          change_detection_mem_to_stream_translator_slave_agent_rf_source_endofpacket;         // Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_source_endofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:in_endofpacket
	wire          change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_valid;            // Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:out_valid -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_sink_valid
	wire  [114:0] change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_data;             // Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:out_data -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_sink_data
	wire          change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_ready;            // Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_sink_ready -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:out_ready
	wire          change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_startofpacket;    // Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:out_startofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_sink_startofpacket
	wire          change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_endofpacket;      // Change_Detection_Mem_to_Stream_Translator_slave_agent_rsp_fifo:out_endofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rf_sink_endofpacket
	wire          change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_valid;          // Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_src_valid -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:in_valid
	wire   [33:0] change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_data;           // Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_src_data -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:in_data
	wire          change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_ready;          // Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:in_ready -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_src_ready
	wire   [31:0] change_detection_stream_to_mem_translator_slave_agent_m0_readdata;                   // Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_readdata -> Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_readdata
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_waitrequest;                // Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_waitrequest -> Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_waitrequest
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_debugaccess;                // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_debugaccess -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_debugaccess
	wire   [20:0] change_detection_stream_to_mem_translator_slave_agent_m0_address;                    // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_address -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_address
	wire    [3:0] change_detection_stream_to_mem_translator_slave_agent_m0_byteenable;                 // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_byteenable -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_byteenable
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_read;                       // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_read -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_read
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_readdatavalid;              // Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_readdatavalid -> Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_readdatavalid
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_lock;                       // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_lock -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_lock
	wire   [31:0] change_detection_stream_to_mem_translator_slave_agent_m0_writedata;                  // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_writedata -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_writedata
	wire          change_detection_stream_to_mem_translator_slave_agent_m0_write;                      // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_write -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_write
	wire    [2:0] change_detection_stream_to_mem_translator_slave_agent_m0_burstcount;                 // Change_Detection_Stream_to_Mem_Translator_slave_agent:m0_burstcount -> Change_Detection_Stream_to_Mem_Translator_slave_translator:uav_burstcount
	wire          change_detection_stream_to_mem_translator_slave_agent_rf_source_valid;               // Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_source_valid -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:in_valid
	wire  [114:0] change_detection_stream_to_mem_translator_slave_agent_rf_source_data;                // Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_source_data -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:in_data
	wire          change_detection_stream_to_mem_translator_slave_agent_rf_source_ready;               // Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:in_ready -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_source_ready
	wire          change_detection_stream_to_mem_translator_slave_agent_rf_source_startofpacket;       // Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_source_startofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:in_startofpacket
	wire          change_detection_stream_to_mem_translator_slave_agent_rf_source_endofpacket;         // Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_source_endofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:in_endofpacket
	wire          change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_valid;            // Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:out_valid -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_sink_valid
	wire  [114:0] change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_data;             // Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:out_data -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_sink_data
	wire          change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_ready;            // Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_sink_ready -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:out_ready
	wire          change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_startofpacket;    // Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:out_startofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_sink_startofpacket
	wire          change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_endofpacket;      // Change_Detection_Stream_to_Mem_Translator_slave_agent_rsp_fifo:out_endofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rf_sink_endofpacket
	wire          change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_valid;          // Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_src_valid -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:in_valid
	wire   [33:0] change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_data;           // Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_src_data -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:in_data
	wire          change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_ready;          // Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:in_ready -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_src_ready
	...
	wire          pixel_dma_addr_translation_slave_agent_rp_valid;                                     // Pixel_DMA_Addr_Translation_slave_agent:rp_valid -> router_003:sink_valid
	wire  [113:0] pixel_dma_addr_translation_slave_agent_rp_data;                                      // Pixel_DMA_Addr_Translation_slave_agent:rp_data -> router_003:sink_data
	wire          pixel_dma_addr_translation_slave_agent_rp_ready;                                     // router_003:sink_ready -> Pixel_DMA_Addr_Translation_slave_agent:rp_ready
	wire          pixel_dma_addr_translation_slave_agent_rp_startofpacket;                             // Pixel_DMA_Addr_Translation_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pixel_dma_addr_translation_slave_agent_rp_endofpacket;                               // Pixel_DMA_Addr_Translation_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          change_detection_mem_to_stream_translator_slave_agent_rp_valid;                      // Change_Detection_Mem_to_Stream_Translator_slave_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] change_detection_mem_to_stream_translator_slave_agent_rp_data;                       // Change_Detection_Mem_to_Stream_Translator_slave_agent:rp_data -> router_004:sink_data
	wire          change_detection_mem_to_stream_translator_slave_agent_rp_ready;                      // router_004:sink_ready -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rp_ready
	wire          change_detection_mem_to_stream_translator_slave_agent_rp_startofpacket;              // Change_Detection_Mem_to_Stream_Translator_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          change_detection_mem_to_stream_translator_slave_agent_rp_endofpacket;                // Change_Detection_Mem_to_Stream_Translator_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          change_detection_stream_to_mem_translator_slave_agent_rp_valid;                      // Change_Detection_Stream_to_Mem_Translator_slave_agent:rp_valid -> router_005:sink_valid
	wire  [113:0] change_detection_stream_to_mem_translator_slave_agent_rp_data;                       // Change_Detection_Stream_to_Mem_Translator_slave_agent:rp_data -> router_005:sink_data
	wire          change_detection_stream_to_mem_translator_slave_agent_rp_ready;                      // router_005:sink_ready -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rp_ready
	wire          change_detection_stream_to_mem_translator_slave_agent_rp_startofpacket;              // Change_Detection_Stream_to_Mem_Translator_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          change_detection_stream_to_mem_translator_slave_agent_rp_endofpacket;                // Change_Detection_Stream_to_Mem_Translator_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                                               // cmd_mux_001:src_valid -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                                                // cmd_mux_001:src_data -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                               // Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                                             // cmd_mux_001:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                                       // cmd_mux_001:src_startofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                         // cmd_mux_001:src_endofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                               // cmd_mux_002:src_valid -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                                                // cmd_mux_002:src_data -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                               // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                                       // cmd_mux_002:src_startofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                         // cmd_mux_002:src_endofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:sink0_endofpacket
	wire          change_detection_mem_to_stream_translator_slave_burst_adapter_source0_valid;         // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_valid -> Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_valid
	wire  [113:0] change_detection_mem_to_stream_translator_slave_burst_adapter_source0_data;          // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_data -> Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_data
	wire          change_detection_mem_to_stream_translator_slave_burst_adapter_source0_ready;         // Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_ready -> Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_ready
	wire    [3:0] change_detection_mem_to_stream_translator_slave_burst_adapter_source0_channel;       // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_channel -> Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_channel
	wire          change_detection_mem_to_stream_translator_slave_burst_adapter_source0_startofpacket; // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_startofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_startofpacket
	wire          change_detection_mem_to_stream_translator_slave_burst_adapter_source0_endofpacket;   // Change_Detection_Mem_to_Stream_Translator_slave_burst_adapter:source0_endofpacket -> Change_Detection_Mem_to_Stream_Translator_slave_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                                               // cmd_mux_003:src_valid -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_003_src_data;                                                                // cmd_mux_003:src_data -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                               // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                                       // cmd_mux_003:src_startofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                         // cmd_mux_003:src_endofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:sink0_endofpacket
	wire          change_detection_stream_to_mem_translator_slave_burst_adapter_source0_valid;         // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_valid -> Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_valid
	wire  [113:0] change_detection_stream_to_mem_translator_slave_burst_adapter_source0_data;          // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_data -> Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_data
	wire          change_detection_stream_to_mem_translator_slave_burst_adapter_source0_ready;         // Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_ready -> Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_ready
	wire    [3:0] change_detection_stream_to_mem_translator_slave_burst_adapter_source0_channel;       // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_channel -> Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_channel
	wire          change_detection_stream_to_mem_translator_slave_burst_adapter_source0_startofpacket; // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_startofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_startofpacket
	wire          change_detection_stream_to_mem_translator_slave_burst_adapter_source0_endofpacket;   // Change_Detection_Stream_to_Mem_Translator_slave_burst_adapter:source0_endofpacket -> Change_Detection_Stream_to_Mem_Translator_slave_agent:cp_endofpacket
	...
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                         // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] pixel_dma_addr_translation_slave_agent_rdata_fifo_out_data;                          // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                         // avalon_st_adapter_001:in_0_ready -> Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                   // avalon_st_adapter_001:out_0_valid -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                    // avalon_st_adapter_001:out_0_data -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                   // Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                   // avalon_st_adapter_001:out_0_error -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
	wire          change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_valid;          // Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_data;           // Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter_002:in_0_ready -> Change_Detection_Mem_to_Stream_Translator_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                   // avalon_st_adapter_002:out_0_valid -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                    // avalon_st_adapter_002:out_0_data -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                   // Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                   // avalon_st_adapter_002:out_0_error -> Change_Detection_Mem_to_Stream_Translator_slave_agent:rdata_fifo_sink_error
	wire          change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_valid;          // Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_data;           // Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter_003:in_0_ready -> Change_Detection_Stream_to_Mem_Translator_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                   // avalon_st_adapter_003:out_0_valid -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                    // avalon_st_adapter_003:out_0_data -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                   // Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                   // avalon_st_adapter_003:out_0_error -> Change_Detection_Stream_to_Mem_Translator_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (System_PLL_sys_clk_clk),                                                 //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset),                            //                    reset.reset
		.uav_address            (change_detection_mem_to_stream_translator_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (change_detection_mem_to_stream_translator_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (change_detection_mem_to_stream_translator_slave_agent_m0_read),          //                         .read
		.uav_write              (change_detection_mem_to_stream_translator_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (change_detection_mem_to_stream_translator_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (change_detection_mem_to_stream_translator_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (change_detection_mem_to_stream_translator_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (change_detection_mem_to_stream_translator_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (change_detection_mem_to_stream_translator_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (change_detection_mem_to_stream_translator_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (change_detection_mem_to_stream_translator_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Change_Detection_Mem_to_Stream_Translator_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (Change_Detection_Mem_to_Stream_Translator_slave_write),                  //                         .write
		.av_read                (Change_Detection_Mem_to_Stream_Translator_slave_read),                   //                         .read
		.av_readdata            (Change_Detection_Mem_to_Stream_Translator_slave_readdata),               //                         .readdata
		.av_writedata           (Change_Detection_Mem_to_Stream_Translator_slave_writedata),              //                         .writedata
		.av_byteenable          (Change_Detection_Mem_to_Stream_Translator_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (Change_Detection_Mem_to_Stream_Translator_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                                                       //              (terminated)
		.av_beginbursttransfer  (),                                                                       //              (terminated)
		.av_burstcount          (),                                                                       //              (terminated)
		.av_readdatavalid       (1'b0),                                                                   //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) change_detection_stream_to_mem_translator_slave_translator (
		.clk                    (System_PLL_sys_clk_clk),                                                 //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset),                            //                    reset.reset
		.uav_address            (change_detection_stream_to_mem_translator_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (change_detection_stream_to_mem_translator_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (change_detection_stream_to_mem_translator_slave_agent_m0_read),          //                         .read
		.uav_write              (change_detection_stream_to_mem_translator_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (change_detection_stream_to_mem_translator_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (change_detection_stream_to_mem_translator_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (change_detection_stream_to_mem_translator_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (change_detection_stream_to_mem_translator_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (change_detection_stream_to_mem_translator_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (change_detection_stream_to_mem_translator_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (change_detection_stream_to_mem_translator_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Change_Detection_Stream_to_Mem_Translator_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (Change_Detection_Stream_to_Mem_Translator_slave_write),                  //                         .write
		.av_read                (Change_Detection_Stream_to_Mem_Translator_slave_read),                   //                         .read
		.av_readdata            (Change_Detection_Stream_to_Mem_Translator_slave_readdata),               //                         .readdata
		.av_writedata           (Change_Detection_Stream_to_Mem_Translator_slave_writedata),              //                         .writedata
		.av_byteenable          (Change_Detection_Stream_to_Mem_Translator_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (Change_Detection_Stream_to_Mem_Translator_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                                                       //              (terminated)
		.av_beginbursttransfer  (),                                                                       //              (terminated)
		.av_burstcount          (),                                                                       //              (terminated)
		.av_readdatavalid       (1'b0),                                                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) change_detection_mem_to_stream_translator_slave_agent (
		.clk                     (System_PLL_sys_clk_clk),                                                              //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),                                         //       clk_reset.reset
		.m0_address              (change_detection_mem_to_stream_translator_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (change_detection_mem_to_stream_translator_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (change_detection_mem_to_stream_translator_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (change_detection_mem_to_stream_translator_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (change_detection_mem_to_stream_translator_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (change_detection_mem_to_stream_translator_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (change_detection_mem_to_stream_translator_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (change_detection_mem_to_stream_translator_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (change_detection_mem_to_stream_translator_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (change_detection_mem_to_stream_translator_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (change_detection_mem_to_stream_translator_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (change_detection_mem_to_stream_translator_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (change_detection_mem_to_stream_translator_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (change_detection_mem_to_stream_translator_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (change_detection_mem_to_stream_translator_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (change_detection_mem_to_stream_translator_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (change_detection_mem_to_stream_translator_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (change_detection_mem_to_stream_translator_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (change_detection_mem_to_stream_translator_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (change_detection_mem_to_stream_translator_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (change_detection_mem_to_stream_translator_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                                                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                                                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                                                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                                                   //                .error
		.rdata_fifo_src_ready    (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) change_detection_mem_to_stream_translator_slave_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                                           //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),                                      // clk_reset.reset
		.in_data           (change_detection_mem_to_stream_translator_slave_agent_rf_source_data),             //        in.data
		.in_valid          (change_detection_mem_to_stream_translator_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (change_detection_mem_to_stream_translator_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (change_detection_mem_to_stream_translator_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (change_detection_mem_to_stream_translator_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (change_detection_mem_to_stream_translator_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                                            // (terminated)
		.csr_read          (1'b0),                                                                             // (terminated)
		.csr_write         (1'b0),                                                                             // (terminated)
		.csr_readdata      (),                                                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) change_detection_mem_to_stream_translator_slave_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                                                     //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.in_data           (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                                      // (terminated)
		.csr_read          (1'b0),                                                                       // (terminated)
		.csr_write         (1'b0),                                                                       // (terminated)
		.csr_readdata      (),                                                                           // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) change_detection_stream_to_mem_translator_slave_agent (
		.clk                     (System_PLL_sys_clk_clk),                                                              //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),                                         //       clk_reset.reset
		.m0_address              (change_detection_stream_to_mem_translator_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (change_detection_stream_to_mem_translator_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (change_detection_stream_to_mem_translator_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (change_detection_stream_to_mem_translator_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (change_detection_stream_to_mem_translator_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (change_detection_stream_to_mem_translator_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (change_detection_stream_to_mem_translator_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (change_detection_stream_to_mem_translator_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (change_detection_stream_to_mem_translator_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (change_detection_stream_to_mem_translator_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (change_detection_stream_to_mem_translator_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (change_detection_stream_to_mem_translator_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (change_detection_stream_to_mem_translator_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (change_detection_stream_to_mem_translator_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (change_detection_stream_to_mem_translator_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (change_detection_stream_to_mem_translator_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (change_detection_stream_to_mem_translator_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (change_detection_stream_to_mem_translator_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (change_detection_stream_to_mem_translator_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (change_detection_stream_to_mem_translator_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (change_detection_stream_to_mem_translator_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                                                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                                                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                                                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                                                   //                .error
		.rdata_fifo_src_ready    (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) change_detection_stream_to_mem_translator_slave_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                                           //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),                                      // clk_reset.reset
		.in_data           (change_detection_stream_to_mem_translator_slave_agent_rf_source_data),             //        in.data
		.in_valid          (change_detection_stream_to_mem_translator_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (change_detection_stream_to_mem_translator_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (change_detection_stream_to_mem_translator_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (change_detection_stream_to_mem_translator_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (change_detection_stream_to_mem_translator_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                                            // (terminated)
		.csr_read          (1'b0),                                                                             // (terminated)
		.csr_write         (1'b0),                                                                             // (terminated)
		.csr_readdata      (),                                                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) change_detection_stream_to_mem_translator_slave_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                                                     //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.in_data           (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                                      // (terminated)
		.csr_read          (1'b0),                                                                       // (terminated)
		.csr_write         (1'b0),                                                                       // (terminated)
		.csr_readdata      (),                                                                           // (terminated)
	...
	Computer_System_mm_interconnect_1_router_002 router_004 (
		.sink_ready         (change_detection_mem_to_stream_translator_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (change_detection_mem_to_stream_translator_slave_agent_rp_valid),         //          .valid
		.sink_data          (change_detection_mem_to_stream_translator_slave_agent_rp_data),          //          .data
		.sink_startofpacket (change_detection_mem_to_stream_translator_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (change_detection_mem_to_stream_translator_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                                 //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset),                            // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (change_detection_stream_to_mem_translator_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (change_detection_stream_to_mem_translator_slave_agent_rp_valid),         //          .valid
		.sink_data          (change_detection_stream_to_mem_translator_slave_agent_rp_data),          //          .data
		.sink_startofpacket (change_detection_stream_to_mem_translator_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (change_detection_stream_to_mem_translator_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                                 //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset),                            // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) change_detection_mem_to_stream_translator_slave_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                                              //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),                                         // cr0_reset.reset
		...
		.source0_valid         (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (change_detection_mem_to_stream_translator_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) change_detection_stream_to_mem_translator_slave_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                                              //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),                                         // cr0_reset.reset
		...
		.source0_valid         (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (change_detection_stream_to_mem_translator_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                                                     // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),                                // in_rst_0.reset
		.in_0_data      (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (change_detection_mem_to_stream_translator_slave_agent_rdata_fifo_out_ready), //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                                                     // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),                                // in_rst_0.reset
		.in_0_data      (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (change_detection_stream_to_mem_translator_slave_agent_rdata_fifo_out_ready), //         .ready
