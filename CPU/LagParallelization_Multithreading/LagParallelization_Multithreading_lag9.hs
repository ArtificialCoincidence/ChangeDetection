...
main = do
    ...
    let target = "0"; readpath = "./../SampleData/test0"; writepath = "./Out/S1/Lag9/LagParallelization/CD0.txt" -- S1
    -- let target = "6"; readpath = "./../SampleData/test6"; writepath = "./Out/K1/Lag9/LagParallelization/CD0.txt" -- K1
    -- let target = "12"; readpath = "./../SampleData/test12"; writepath = "./Out/F1/Lag9/LagParallelization/CD0.txt" -- F1
    -- let target = "18"; readpath = "./../SampleData/test18"; writepath = "./Out/AF1/Lag9/LagParallelization/CD0.txt" -- AF1
    ...
    tid3 <- forkIO $ do
        ...
        let readpathc = readpath ++ "/Iref" ++ target ++ "E.dat"
    ...
    tid4 <- forkIO $ do
        ...
        let readpathd = readpath ++ "/Iref" ++ target ++ "G.dat"
    ...
    tid5 <- forkIO $ do
        ...
        let readpathe = readpath ++ "/Iref" ++ target ++ "I.dat"
    ...
    tid6 <- forkIO $ do
        ...
        let readpathf = readpath ++ "/Iref" ++ target ++ "K.dat"
    ...
    tid7 <- forkIO $ do
        ...
        let readpathg = readpath ++ "/Iref" ++ target ++ "M.dat"
    ...
    tid8 <- forkIO $ do
        ...
        let readpathh = readpath ++ "/Iref" ++ target ++ "O.dat"
        ref8 <- openFile readpathh ReadMode; contentsRef8 <- hGetContents ref8
        let
    ...
    tid9 <- forkIO $ do
        ...
        let readpathi = readpath ++ "/Iref" ++ target ++ "Q.dat"
    ...
    --  ghc -O2 LagParallelization_Multithreading_lag9.hs -threaded -rtsopts -eventlog
    -- ./LagParallelization_Multithreading_lag9 +RTS -N8 -ls; threadscope LagParallelization_Multithreading_lag9.eventlog
