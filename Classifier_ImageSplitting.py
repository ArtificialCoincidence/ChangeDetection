...
if __name__ == "__main__":
    ...
    idtest = 0
    test = ['ImageSplitting_Multiprocessing', 'ImageSplitting_Multithreading']
    ...
    if test[idtest] == 'ImageSplitting_Multiprocessing':
      path = './ImageSplitting_Multiprocessing/OutMP/%s/Lag%s/ImageSplitting/'%(Pair[idPair],Lag[idlag])
    ...
    elif test[idtest] == 'ImageSplitting_Multithreading':
      path = './ImageSplitting_Multithreading/Out/%s/Lag%s/ImageSplitting/'%(Pair[idPair],Lag[idlag])
      TestName = test[idtest]+'_'+'MC'+str(Lag[idlag])+'AR1'
    ...
    # elif test[idtest] == 'ParDai':
    #   path = './LagParallelization_Multithreading/Out/%s/Lag%s/LagParallelization/'%(Pair[idPair],Lag[idlag])
    #   TestName = test[idtest]+'_'+'MC'+str(Lag[idlag])+'AR1'
    ...
    # elif test[idtest] == 'SeqDai':
    #   path = '/home/marcello-costa/workspace/ChangeDetection/Out/%s/Lag%s/SeqDai/'%(Pair[idPair],Lag[idlag])
    #   TestName = test[idtest]+'_'+'MC'+str(Lag[idlag])+'AR1'
